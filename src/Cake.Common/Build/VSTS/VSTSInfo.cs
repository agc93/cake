...
namespace Cake.Common.Build.VSTS
{
    ...
    public abstract class VSTSInfo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VSTSInfo"/> class.
        /// </summary>
        /// <param name="environment">The environment.</param>
        protected VSTSInfo(ICakeEnvironment environment)
        {
        ...
        /// <summary>
        /// Gets the current repository type as a <see cref="VSTSRepositoryType"/> from an environment variable.
        /// </summary>
        /// <param name="variable">The environment variable name.</param>
        /// <returns>The current repository type.</returns>
        protected VSTSRepositoryType? GetRepositoryType(string variable)
        {
            var value = GetEnvironmentString(variable);
            VSTSRepositoryType type;

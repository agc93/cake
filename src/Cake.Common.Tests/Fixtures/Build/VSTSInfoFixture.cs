...
namespace Cake.Common.Tests.Fixtures.Build
{
    public class VSTSInfoFixture
    {
        ...
        public VSTSEnvironmentInfo CreateEnvironmentInfo()
        {
            return new VSTSEnvironmentInfo(Environment);
        }

        public VSTSRepositoryInfo CreateRepositoryInfo()
        {
            return new VSTSRepositoryInfo(Environment);
        }

        public VSTSRepositoryInfo CreateRepositoryInfo(string repoType)
        {
            Environment.GetEnvironmentVariable("BUILD_REPOSITORY_PROVIDER").Returns(repoType);
            return CreateRepositoryInfo();
        }

        public VSTSAgentInfo CreateAgentInfo()
        {
            return new VSTSAgentInfo(Environment);
        }

        public VSTSBuildInfo CreateBuildInfo()
        {
            return new VSTSBuildInfo(Environment);
        }

        public VSTSDefinitionInfo CreateDefinitionInfo()
        {
            return new VSTSDefinitionInfo(Environment);
        }

        public VSTSTeamProjectInfo CreateTeamProjectInfo()
        {
            return new VSTSTeamProjectInfo(Environment);
        }
    }
}
